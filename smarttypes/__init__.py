...
site_description = """
SmartTypes is an open lab for online social discovery (initially twitter).
By mapping our social world, we make it easy to find new and interesting communities of people."""
